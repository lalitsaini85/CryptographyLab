 ...
 * Date: 11/12/2022
 * Time: 10:04 PM
 * File Name : ColumnerTransposition.java
 */
public class ColumnerTransposition {
    ...
    public static void main(String[] args) {
        ColumnerTransposition tc = new ColumnerTransposition();
        System.out.println("Encrypted Message is: "
                + tc.doEncryption("LalitSaini"));
        System.out.println("Decrypted Message is: "
                + tc.doDecryption(tc.doEncryption("LalitSaini")));
    }
